              ...
              <div className="lg:w-2/3 md:flex">
                ...
                <div className="md:w-3/4 mx-2">
                  <div>
                    ...
                    <p className="text-base sm:text-lg mt-2">What direction is crowd going?  Where is the “sharp” money? WYG provides free, easily-understandable, and valuable information will help you make better decisions and payouts.</p>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4 mt-4">
                    <a href={configData?.middleBanners[0].href} target="_blank" className='flex text-center justify-center mr-2 h-fit my-2 rounded-lg min-w-56 w-full cursor-pointer relative'>
                      <img src={configData?.middleBanners[0].src} className='w-2/3 sm:w-[250px] aspect-ratio rounded' alt="" />
                    </a>
                    <a href={configData?.middleBanners[1].href} target="_blank" className='flex text-center justify-center mr-2 h-fit my-2 rounded-lg min-w-56 w-full cursor-pointer relative'>
              ...
              <div className="sm-full md:w-3/4 float-right lg:w-1/3 lg:mx-6 lg:block grid lg:grid-cols-1 grid-cols-2 text-[#aaa] mt-8">
                {
                  configData?.rightBanners?.map((val, ind) => (
                    <div className="m-2 flex" key={ind}>
                      <a href={val.href} target="_blank" className='sm:flex items-center mx-2 h-fit rounded-lg min-w-56 w-full cursor-pointer md:flex' >
                        <img src={val?.src} className=' aspect-square rounded mx-auto w-full sm:w-[125px] h-auto sm:h-[125px]' alt="" />
